...
import com.lee.timeselector.adapter.NumericWheelAdapter;
import com.lee.timeselector.inter.OnItemSelectedListener;
import com.lee.timeselector.view.WheelView;
...
public class WheelTime {
    ...
    public void setRangDate(Calendar startDate, Calendar endDate) {
        ...
        if (startDate == null && endDate != null) {
            ...
            @SuppressLint("WrongConstant") int year = startDate.get(Calendar.YEAR);
            @SuppressLint("WrongConstant") int month = startDate.get(Calendar.MONTH) + 1;
            @SuppressLint("WrongConstant") int day = startDate.get(Calendar.DAY_OF_MONTH);
            if (year < endYear) {
